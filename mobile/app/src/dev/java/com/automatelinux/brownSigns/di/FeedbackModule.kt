package com.automatelinux.brownSigns.di
...
// Dev flavor only: the feedback widget talks to the same backend as the app.
@Module
...
object FeedbackModule {
    ...
    fun provideFeedbackConfig(): FeedbackConfig =
        FeedbackConfig(appName = "brownSigns", currentScreenProvider = { ScreenTracker.currentScreen })
}
